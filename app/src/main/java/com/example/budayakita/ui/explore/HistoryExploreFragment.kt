 ...
 * Use the [HistoryExploreFragment.newInstance] factory method to
...
class HistoryExploreFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_history_explore, container, false)
    }
